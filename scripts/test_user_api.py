...
def run_tests(user_id):
    ...
    try:
        ...
        response = requests.get(
            f"{USER_URL}/codeexists", params={"code": "admin"}, headers=headers
        )
        print(response.text)
        ...
        response = requests.put(
            f"{USER_URL}/{user_id}", json=update_data, headers=headers
        )
        print(response.text)
        ...
        response = requests.patch(
            f"{USER_URL}/{user_id}/password", json=password_data, headers=headers
        )
        print(response.text)
