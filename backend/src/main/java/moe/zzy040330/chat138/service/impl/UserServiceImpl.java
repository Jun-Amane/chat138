...
import moe.zzy040330.chat138.mapper.UserMapper;
...
public class UserServiceImpl extends GenericCrudServiceImpl<User, Long> implements UserService {
    ...
    public UserServiceImpl(GenericMapper<User, Long> genericMapper, UserMapper userMapper, PasswordEncoder passwordEncoder) {
        super(genericMapper);
